...
import rigoImage from "../../img/gallery.png";
  ...
  return (
    <div className="jumbotron">
      ...
      <link
        ...
        rel="stylesheet"
      />
<h1 className="title  fw-bold m-5">Gallery Pictures</h1>
...
que realice al conocer la librería framer-motion.
</p>

  <p className="taskText">
  Esta galería está desarrollada con React.js y la librería framer-motion.  </p>

  <p className="taskText"> 
  Como se puede observar esta librería crea un aspecto muy profesional a tus proyectos, en la que se puede aplicar a muchos componentes como catálogos, galerías, card, etc … en los proyectos que puedas desarrollar.  </p>
</div>
...
{/*********************************************************/}
      ...
      <div className="col-md-8 offset-md-1 mt-5">
        ...
        <a
          ...
          href="https://gallery-pictures.vercel.app/"
          target="_blank"
        >
          <svg
        ...
        <a
          ...
          href="https://github.com/Rodricasares/-Gallery-pictures"
          target="_blank"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="col">
            ...
            <p className="fw-bold mt-3">
              ...
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-code-slash ms-2"
                viewBox="0 0 16 16"
              >
